package generics;
//they restrict the type of objects to be allowed into generics


import java.util.Arrays;

public class wildcard_ex<T extends Number> { //restricted only to float int double etc
    
    //here T is either umber or its subclass
